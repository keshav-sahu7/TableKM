...
//static QLineEdit *cloneCellWidget(QLineEdit *edit)
//{
//    QLineEdit *temp_edit = new QLineEdit(edit->text());
//    temp_edit->setValidator(edit->validator());
...
static void swapColumnTableRow(QTableWidget *table, int index, int swap_with)
{
    ...
    // swap column default value field
    //auto def_value_1 = cloneCellWidget(dynamic_cast<QLineEdit *>(table->cellWidget(index, 3)));
    //auto def_value_2 = cloneCellWidget(dynamic_cast<QLineEdit *>(table->cellWidget(swap_with, 3)));
    //table->removeCellWidget(index, 3);
    //table->removeCellWidget(swap_with, 3);
    //table->setCellWidget(index, 3, def_value_2);
    //table->setCellWidget(swap_with, 3, def_value_1);
}
